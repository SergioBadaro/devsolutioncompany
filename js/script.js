...
function carregarFuncionarios() {
    ...
    lista.forEach((f, i) => {
        ...
        tr.innerHTML = `
            ...
            <td class="border border-gray-300 px-4 py-2">R$ ${parseFloat(f.salario).toLocaleString('pt-BR', {minimumFractionDigits: 2})}</td>
            <td class="border border-gray-300 px-4 py-2">${f.dataContratacao}</td>
...
function abrirModal(index) {
    ...
    document.getElementById('detalhesFuncionario').innerHTML = `
        ...
        <p><strong>Salário:</strong> R$ ${parseFloat(f.salario).toLocaleString('pt-BR', {minimumFractionDigits: 2})}</p>
...
function carregarMetricas() {
    ...
    if (document.getElementById('cadastradosMes')) document.getElementById('cadastradosMes').textContent = cadastradosMes;
    if (document.getElementById('contratacoesMes')) document.getElementById('contratacoesMes').textContent = contratacoesMes;
    if (document.getElementById('demissoesMes')) document.getElementById('demissoesMes').textContent = demissoesMes;
    if (document.getElementById('totalFuncionarios')) document.getElementById('totalFuncionarios').textContent = total;
    if (document.getElementById('ativos')) document.getElementById('ativos').textContent = ativos;
    if (document.getElementById('licenca')) document.getElementById('licenca').textContent = licenca;
    if (document.getElementById('ferias')) document.getElementById('ferias').textContent = ferias;
}
